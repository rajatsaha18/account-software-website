...
<head>
    <title>@yield('title') | Accounting Software</title><!-- [Meta] -->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('public/admin/assets/fonts/tabler-icons.min.css') }}"><!-- [Feather Icons] https://feathericons.com -->
    <link rel="stylesheet" href="{{ asset('public/admin/assets/fonts/feather.cs') }}s">
    ...
    <script src="{{ asset('public/admin/assets/js/tech-stack.js') }}"></script>
...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-layout="vertical" data-pc-direction="ltr"
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="theme-main-layout d-flex align-center gap-1 w-100"><a href="#!"
                                ...
                                data-bs-toggle="tooltip" title="Horizontal" data-value="horizontal"><img
                                    ...
                                    alt="img" class="img-fluid"> </a><a href="#!"
                                data-bs-toggle="tooltip" title="Color Header" data-value="color-header"><img
                                    src="https://ableproadmin.com/assets/images/customizer/color-header.svg"
                                    alt="img" class="img-fluid"> </a><a href="#!"
                                data-bs-toggle="tooltip" title="Compact" data-value="compact"><img
    ...
    <script src="{{ asset('public/admin/assets/js/plugins/bootstrap.min.js') }}"></script>public/
